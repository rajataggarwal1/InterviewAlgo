...
/*
 * Given a binary tree, find the largest path between any two nodes. The path need not necessarily include the root note. 
 *  The size of the path is the sum of all the nodes on the path. 
